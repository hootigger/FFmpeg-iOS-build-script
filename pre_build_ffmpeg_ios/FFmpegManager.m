...
// 执行指令
- (void)runCmd:(NSString *)commandStr completionBlock:(void (^)(NSError *))compleBlock {
    ...
    dispatch_async(dispatch_get_global_queue(0, 0), ^{
        ...
        self.isRuning = YES;
        self.completionBlock = compleBlock;
        // 根据 空格 将指令分割为指令数组
        ...
        for (int i = 0; i < argc; i++) {
            args[i] = [argv_array[i] UTF8String];
        }
