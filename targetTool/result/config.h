...
#define FFMPEG_CONFIGURATION "--target-os=darwin --arch=arm64 --cc='xcrun -sdk iphoneos clang' --as='gas-preprocessor.pl -arch aarch64 -- xcrun -sdk iphoneos clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --disable-ffplay --disable-ffprobe --disable-ffserver --enable-small --extra-cflags='-arch arm64 -mios-version-min=8.0 -fembed-bitcode' --extra-ldflags='-arch arm64 -mios-version-min=8.0 -fembed-bitcode' --prefix=/Users/guogh/Desktop/demo/FFmpeg-iOS-build-script-clip/thin/arm64"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2017
#define FFMPEG_DATADIR "/Users/guogh/Desktop/demo/FFmpeg-iOS-build-script-clip/thin/arm64/share/ffmpeg"
#define AVCONV_DATADIR "/Users/guogh/Desktop/demo/FFmpeg-iOS-build-script-clip/thin/arm64/share/ffmpeg"
